...
import { h, Component, ComponentInterface, Prop, State, Event, EventEmitter } from '@stencil/core';
import { kSlider, ISliderValueChangedDetail, ISliderTickmark } from './model';
